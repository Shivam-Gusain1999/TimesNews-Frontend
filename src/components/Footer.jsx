            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                    ...
                    <div>
                        ...
                        <div className="flex">
                            <input
                                ...
                                className="flex-1 px-4 py-2.5 bg-white/10 border border-white/10 rounded-l-lg text-sm text-white placeholder:text-gray-500 focus:outline-none focus:border-primary transition-colors"
                            />
                            <button className="px-5 py-2.5 bg-primary hover:bg-primary-dark text-white text-sm font-medium rounded-r-lg transition-colors">
                                Subscribe
                            </button>
                        </div>
                    </div>
                ...
                <div className="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        ...
                        <a href="#" className="text-gray-500 text-xs hover:text-primary transition-colors">Cookie Policy</a>
                    </div>
                </div>
            </div>
        </footer>
